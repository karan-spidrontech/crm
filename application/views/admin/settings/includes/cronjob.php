...
<div class="tab-content">
 ...
 <div role="tabpanel" class="tab-pane" id="contracts">
  ...
  <hr />
   <?php echo render_input('settings[contract_expiration_before]','send_expiry_reminder_before',get_option('contract_expiration_before'),'number',array('data-toggle'=>'tooltip','title'=>'settings_reminders_contracts_tooltip')); ?>
 </div>
...
<div role="tablpanel" class="tab-pane" id="expenses">
   <?php echo render_input('settings[expenses_auto_operations_hour]','hour_of_day_perform_auto_operations',get_option('expenses_auto_operations_hour'),'number',array('data-toggle'=>'tooltip','data-title'=>_l('hour_of_day_perform_auto_operations_format'),'max'=>23)); ?>
</div>
</div>
