...
// Deadline
$html .= '<b>' . _l('project_deadline') . ': </b>' . _d($project->deadline) . '<br /><br />';
// Total Days
...
$pdf->MultiCell(($dimensions['wk'] / $divide_document_overview) - $dimensions['lm'], 0, $html, 0, 'L', 0, 0, '', '', true, 0, true, true, 0);
...
foreach($tasks as $task){
    $logged_time = $this->tasks_model->calc_task_total_time($task['id']);
    $html .= '<tr style="color:#4a4a4a;">';
