            ...
            <div class="col-md-2 border-right" style="margin-top:-5px;">
              <div class="form-group">
                ...
                <div class="radio radio-primary">
                  <input type="radio" id="filter_startdate" name="month_from" value="startdate"  <?php if($this->input->post('month_from') == 'startdate' || !$this->input->post('month_from')){echo 'checked';} ?>>
                  <label for="filter_startdate"><?php echo _l('tasks_dt_datestart'); ?></label>
                </div>
                <div class="radio radio-primary">
                  <input type="radio" id="filter_duedate" name="month_from" value="duedate" <?php if($this->input->post('month_from') == 'duedate'){echo 'checked';} ?>>
