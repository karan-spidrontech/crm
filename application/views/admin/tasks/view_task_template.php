...
<?php if($this->input->post('opened_from_lead_id')){
   echo '<a href="#" onclick="init_lead('.$this->input->post('opened_from_lead_id').'); return false;" class="text-success back-to-from-task" data-placement="left" data-toggle="tooltip" data-title="'._l('back_to_lead').'"><i class="fa fa-history" aria-hidden="true"></i></a>';
}
?>
                  ...
                  <div data-commentid="<?php echo $attachment['comment_file_id']; ?>" data-task-attachment-id="<?php echo $attachment['id']; ?>" class="task-attachment-col col-md-6<?php if($i > $show_more_link_task_attachments){echo ' hide task-attachment-col-more';} ?>">
                     <ul class="list-unstyled task-attachment-wrapper">
                        <li class="mbot10 task-attachment<?php if(strtotime($attachment['dateadded']) >= strtotime('-16 hours')){echo ' highlight-bg'; } ?>">
                           ...
                           <div class="clearfix"></div>
                           <?php ob_start(); ?>
                           <div class="<?php if($is_image){echo 'preview-image';}else{echo 'task-attachment-no-preview';} ?>">
               ...
               <div class="task-single-menu task-menu-status pull-right">
                  ...
                  <div class="content-menu hide">
                     <ul>
                        ...
                        <li><a href="#" onclick="task_mark_as(<?php echo $status['id']; ?>,<?php echo $task->id; ?>); return false;">
