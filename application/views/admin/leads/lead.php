   ...
   <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane" id="tab_email_activity">
         ...
         <div class="lead-email-activity">
            ...
            <h4 class="bold no-margin lead-mail-activity-subject"><?php echo $_mail_activity['subject']; ?><br /> <small class="text-muted display-block"><?php echo _dt($_mail_activity['dateadded']); ?></small></h4>
