...
<script>
   $(function(){
     ...
     // For multi select checkbox selected change, update value on the main form
     $('body').on('change','input[type="checkbox"].option-selected',function(){
          var value = $(this).next().val();
          $('body').find('option[value="'+value+'"]').prop('selected',($(this).is(':checked') ? true : false));
     });
