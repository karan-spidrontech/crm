     ...
     <div class="col-md-12">
      <div class="panel_s">
       ...
       <div class="col-md-3">
        ...
        <div class="mtop10 hide relative" id="group_by_tasks_wrapper">
...
<script>
 ...
 $(function() {
  ...
  timesheetsTable.on('init.dt',function(){
    var $dtButtons = $('body').find('.dataTables_wrapper .dt-buttons');
    var $gr = $('#group_by_tasks_wrapper').clone()
    $('#group_by_tasks_wrapper').remove()
    $gr.removeClass('hide').addClass('pull-right')
    $gr.find('span').css('position','absolute');
    $gr.find('span').css('top','3px');
    $gr.find('span').css('left','-90px');
    $dtButtons.after($gr);
  });
