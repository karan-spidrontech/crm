      ...
      <div class="col-md-5 left-column">
        <div class="panel_s">
          <div class="panel-body">
            ...
            <div class="form-group">
              <label for="clientid"><?php echo _l('contract_client_string'); ?></label>
              <select id="clientid" name="client" data-live-search="true" data-width="100%" class="selectpicker ajax-search" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
