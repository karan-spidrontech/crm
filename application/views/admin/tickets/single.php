									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<select name="contactid" id="contactid" class="selectpicker ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
												<?php
