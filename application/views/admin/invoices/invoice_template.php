...
<div class="panel_s invoice accounting-template">
   ...
   <div class="panel-body">
      ...
      <div class="row">
         ...
         <?php // Check if any recurring invoices are made from this invoice
            if(isset($invoice) && ($invoice->recurring !== 0 && $invoice->last_recurring_date != NULL)){ ?>
         <?php if(count($invoice_recurring_invoices)){ ?>
         <div class="col-md-12">
            <p class="text-muted"><?php echo _l('invoice_add_edit_recurring_invoices_from_invoice'); ?></p>
            ...
            <tbody>
               ...
               <?php if (isset($invoice) || isset($add_items)) {
                  ...
                  foreach ($add_items as $item) {
                    ...
                    $table_row .= '</td>';
                    $table_row .= '<td class="rate"><input type="text" data-toggle="tooltip" title="' . _l('numbers_not_formatted_while_editing') . '" onblur="calculate_total();" onchange="calculate_total();" name="' . $items_indicator . '[' . $i . '][rate]" value="' . $item['rate'] . '" class="form-control"></td>';
