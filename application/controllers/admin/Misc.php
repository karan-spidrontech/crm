...
class Misc extends Admin_controller
{
    ...
    {
        $this->misc_model->mark_all_notifications_as_read_inline($id);
    }
            ...
            foreach ($tables as $table_data) {
                ...
                foreach ($fields as $field) {
                    ...
                    if (strpos($field_type, 'decimal') !== false) {
                        ...
                        $this->db->query("ALTER TABLE $table CHANGE $field $field DECIMAL(11,$total_decimals) $field_is_null$field_default_value;");
                    }
                }
            }
