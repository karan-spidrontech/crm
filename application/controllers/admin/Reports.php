        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($rResult as $aRow) {
                ...
                for ($i = 0; $i < count($aColumns); $i++) {
                    ...
                    } elseif ($aColumns[$i] == 'total' || $aColumns[$i] == 'subtotal' || $aColumns[$i] == 'total_tax' || $aColumns[$i] == 'discount_total' || $aColumns[$i] == 'adjustment') {
                        if ($_data == null) {
                            $_data = 0;
                        }
                    ...
                    } elseif ($aColumns[$i] == 'date' || $aColumns[$i] == 'open_till') {
                        $_data = _d($_data);
                    } elseif ($aColumns[$i] == 'proposal_to') {
                        if (!empty($_data)) {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($rResult as $aRow) {
                ...
                for ($i = 0; $i < count($aColumns); $i++) {
                    ...
                    } elseif ($aColumns[$i] == 'date' || $aColumns[$i] == 'expirydate') {
                        $_data = _d($_data);
                    } elseif ($aColumns[$i] == 'invoiceid') {
                        if ($_data == null) {
                            $_data = '';
        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($rResult as $aRow) {
                ...
                for ($i = 0; $i < count($aColumns); $i++) {
                    ...
                    } elseif ($aColumns[$i] == 'date' || $aColumns[$i] == 'duedate') {
                        $_data = _d($_data);
                    }
                    $row[] = $_data;
                }
